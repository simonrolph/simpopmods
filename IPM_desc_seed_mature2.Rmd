---
title: "IPM Descriptor Object - IPM_desc_seed_mature2"
...
class(IPM_desc_seed_mature2) <- append(class(IPM_desc_seed_mature2),'IPM_descriptor')

# Save the IPM descriptor object
save(IPM_desc_seed_mature2,file = stop("'file' must be specified"))
```
